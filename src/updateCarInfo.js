                        ...
                        if (existsWithoutCar) {
                            ...
                            try {
                                ...
                                if (e.response.data.errorDetails[0].includes('No route was found') || 
                                    e.response.data.errorDetails[0].includes('The route distance is too long to calculate a route') ||
                                    e.response.data.errorDetails[0].includes('One or more waypoints can\'t be routed')) {
